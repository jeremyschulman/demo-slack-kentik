payload = {
    "api_query": {
        ...
        "ttl": 36000,
        "queries": [
            {"bucket": "Flow", "isOverlay": False, "query": {
                "all_devices": False,
                "aggregateTypes": ["avg_bits_per_sec",
                                   "p95th_bits_per_sec",
                                   "max_bits_per_sec"],
                "aggregateThresholds": {}, "bracketOptions": "",
                "hideCidr": False, "cidr": 32, "cidr6": 128,
                "customAsGroups": True, "cutFn": {},
                "cutFnRegex": {},
                "cutFnSelector": {}, "depth": 75,
                "descriptor": "",
                "device_name": [], "device_labels": [],
                "device_sites": [], "device_types": ["mpls"],
                "fastData": "Auto",
                ...
                "aggregateFilters": [], "hostname_lookup": True,
                "isOverlay": False, "lookback_seconds": 3600,
                ...
                "generatorTopx": 8, "matrixBy": [],
                "metric": ["bytes"],
                "forceMinsPolling": False, "mirror": False,
                "mirrorUnits": True,
                "outsort": "avg_bits_per_sec",
                "overlay_day": -7,
                "overlay_timestamp_adjust": False,
                "query_title": "", "secondaryOutsort": "",
                "secondaryTopxSeparate": False,
                "secondaryTopxMirrored": False,
                "show_overlay": True,
                "show_total_overlay": True,
                "starting_time": None,
                "ending_time": None, "sync_all_axes": False,
                "sync_axes": False, "sync_extents": True,
                "show_site_markers": False, "topx": 13,
                "update_frequency": 0, "use_log_axis": False,
                "use_secondary_log_axis": False,
                "viz_type": "sankey",
                "aggregates": [{"value": "avg_bits_per_sec",
                                 ...
                                 "filters": [
                                     {
                                         ...
                                         "operator": "=",
                                         "filterValue": "example_site_name"}],
                                 "saved_filters": [],
                                 "filterGroups": []}]},
                "dimension": ["i_device_site_name",
                              "InterfaceID_src",
                              "IP_src", "InterfaceID_dst",
                              "IP_dst"]}}],
    }
}
